...
export default class MongooseQueueServerRepository implements QueueServerRepository {
  ...
  constructor(connection: mongoose.Connection, private transformer: QueueServerMongooseTransformer) {
    this.Model = connection.model<IQueueServer & mongoose.Document>("QueueServer", QueueServerSchema);
  }
